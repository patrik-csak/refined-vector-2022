...
| Before | After |
|---|---|
| <picture><source media="(prefers-color-scheme: dark)" srcset="screenshots/fonts-unrefined-dark.png"><source media="(prefers-color-scheme: light)" srcset="screenshots/fonts-unrefined-light.png"><img src="screenshots/fonts-unrefined-light.png" alt="Wikipedia article with default sans-serif body font"></picture> | <picture><source media="(prefers-color-scheme: dark)" srcset="screenshots/fonts-refined-dark.png"><source media="(prefers-color-scheme: light)" srcset="screenshots/fonts-refined-light.png"><img src="screenshots/fonts-refined-light.png" alt="Wikipedia article with serif body font"></picture> |
| <picture><source media="(prefers-color-scheme: dark)" srcset="screenshots/monospace-unrefined-dark.png"><source media="(prefers-color-scheme: light)" srcset="screenshots/monospace-unrefined-light.png"><img src="screenshots/monospace-unrefined-light.png" alt="Wikipedia text where inline monospaced text is only differentiated by monospace font family"></picture> | <picture><source media="(prefers-color-scheme: dark)" srcset="screenshots/monospace-refined-dark.png"><source media="(prefers-color-scheme: light)" srcset="screenshots/monospace-refined-light.png"><img src="screenshots/monospace-refined-light.png" alt="Wikipedia text where inline monospaced text uses monospace font family, background color, border, and padding"></picture> |
